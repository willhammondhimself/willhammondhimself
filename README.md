...
I'm a Physics, Math, and CS student at Pitzer College. I spend a lot of my time across the street at Harvey Mudd taking classes and playing poker.

Most of my work is in quantitative trading and research. I focus on options pricing, market making, and systematic strategies. I'm targeting Summer 2027 QT and QR internships.

Things that are important to me when I write code: clear baselines, careful experiments, and making sure another person could clone and run my work without fighting it.
...
**[Market Mind](https://github.com/willhammondhimself/market-mind)** - A market making simulator that covers bid-ask spread optimization, inventory management, and adverse selection.

**[10,000 Dice Game](https://github.com/willhammondhimself/10-000-dice-game)** - A multiplayer dice game with a GTO strategy engine and 217 unit tests.
